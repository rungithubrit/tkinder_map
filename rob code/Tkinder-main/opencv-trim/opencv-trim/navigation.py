...
def login():
    ...
    #logo2resized=pic.resize((300,300))
    ...
    b1=Button(root,text="Click here...",bg="#FFFFFF",fg="#0F2167",font=("Arial",20),borderwidth=0,command=registerpage).place(x=780,y=595)
    b2=Button(root,text="Login",bg="#0F2167",fg="white",font=("Arial",20),borderwidth=0,width=7,command=homepage).place(x=710,y=510)
...
def registerpage():
    ...
    b1=Button(root,text="Register",bg="#D9D9D9",font=("Arial",24),borderwidth=5,command=login,width=15).place(x=640,y=650)  
...
def homepage():
    ...
    b5=Button(cn_side,text="Safety check",bg="#363062",font=("Arial",16),borderwidth=0,width=15,fg='white',command=safetypage).place(x=20,y=375)
...
def safetypage():
    ...
    cn=Canvas(root,bg='#FFFFFF',height='500',width="650").place(x=140,y=20)
    ...
    newpic=ImageTk.PhotoImage(resized)
    piclab=Button(image=newpic,borderwidth=0,bg="#0F2167",command=homepage).place(x=20,y=20)
    def thing():
